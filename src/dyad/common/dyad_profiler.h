...
#include <caliper/cali.h>
  ...
  #define DYAD_CPP_REGION_UPDATE(name, key, value) DLIO_PROFILER_CPP_REGION_DYN_UPDATE((name), (key), (value))
#endif
#endif
...
extern "C" {
  ...
  #define DYAD_C_REGION_UPDATE_INT(name, key, value) DLIO_PROFILER_C_REGION_UPDATE_INT((name), (key), (value))
  #define DYAD_C_REGION_UPDATE_STR(name, key, value) DLIO_PROFILER_C_REGION_UPDATE_STR((name), (key), (value))
#endif
