...
macro(dyad_add_compiler_flags MY_FLAGS)
  foreach(flag ${ARGN})
...
dyad_add_compiler_flags(CMAKE_CXX_FLAGS
  -fPIC -Wall -Wextra -pedantic -Wno-unused-parameter -Wnon-virtual-dtor
  -Wno-deprecated-declarations)

dyad_add_compiler_flags(CMAKE_C_FLAGS
  -fPIC -Wall -Wextra -pedantic -Wno-unused-parameter -Wnon-virtual-dtor
  -Wno-deprecated-declarations)
...
if (CMAKE_CXX_COMPILER_ID MATCHES "Clang")
  if (USE_CLANG_LIBCXX)
    dyad_add_compiler_flags(CMAKE_CXX_FLAGS "--stdlib=libc++")
  else (USE_CLANG_LIBCXX)
    if (GCC_TOOLCHAIN)
      dyad_add_compiler_flags(CMAKE_CXX_FLAGS "--gcc-toolchain=${GCC_TOOLCHAIN}")
    endif (GCC_TOOLCHAIN)
  ...
  if (CMAKE_BUILD_TYPE MATCHES Debug)
    ...
    dyad_add_compiler_flags(CMAKE_CXX_FLAGS -fno-omit-frame-pointer)
    dyad_add_compiler_flags(CMAKE_C_FLAGS -fno-omit-frame-pointer)
  endif ()
endif ()
...
if (CMAKE_CXX_COMPILER_ID MATCHES "Intel")
  ...
  # -openmp_profile
  dyad_add_compiler_flags(CMAKE_CXX_FLAGS -diag-disable=2196 -wd1011 -wd1875 -diag-disable=11074 -diag-disable=11076 ${GCC_INTEROP})
  dyad_add_compiler_flags(CMAKE_C_FLAGS -diag-disable=2196 -wd1011 -wd1875 -diag-disable=11074 -diag-disable=11076 ${GCC_INTEROP})
endif ()
