...
void set_flist (std::string base, flist_t& flist)
{
    ...
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_dec_fc0_bias_64x1.bin", 272));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_dec_fc0_matrix_64x20.bin",
                        5136));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_dec_fc1_bias_128x1.bin", 528));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_dec_fc1_matrix_128x64.bin",
                        32784));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_dec_fc2_bias_256x1.bin", 1040));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_dec_fc2_matrix_256x128.bin",
                        131088));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_disc0_fc0_bias_128x1.bin",
                        528));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_disc0_fc0_matrix_128x16419.bin",
                        8406544));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_disc0_fc1_bias_64x1.bin", 272));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_disc0_fc1_matrix_64x128.bin",
                        32784));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_disc0_fc2_bias_1x1.bin", 20));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_disc0_fc2_matrix_1x64.bin",
                        272));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_disc1_fc0_bias_128x1.bin",
                        528));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_disc1_fc0_matrix_128x16419.bin",
                        8406544));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_disc1_fc1_bias_64x1.bin", 272));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_disc1_fc1_matrix_64x128.bin",
                        32784));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_disc1_fc2_bias_1x1.bin", 20));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_disc1_fc2_matrix_1x64.bin",
                        272));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_enc_fc0_bias_32x1.bin", 144));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_enc_fc0_matrix_32x16399.bin",
                        2099088));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_enc_fc1_bias_256x1.bin", 1040));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_enc_fc1_matrix_256x32.bin",
                        32784));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_enc_fc2_bias_128x1.bin", 528));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0_enc_fc2_matrix_128x256.bin",
                        131088));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0enc_out_bias_20x1.bin", 96));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0enc_out_matrix_20x128.bin",
                        10256));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0pred_y_bias_16399x1.bin",
                        65612));
    flist.push_back (
        std::make_pair (base + "model_weights_macc_wae0pred_y_matrix_16399x256.bin",
                        16792592));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0_dec_fc0_bias_optimizer_"
    ...
    flist.push_back (std::make_pair (base
                                     ...
                                     272));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0_dec_fc0_matrix_optimizer_"
    ...
    flist.push_back (std::make_pair (base
                                     ...
                                     5136));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0_dec_fc1_bias_optimizer_"
    ...
    flist.push_back (std::make_pair (base
                                     ...
                                     528));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0_dec_fc1_matrix_optimizer_"
    ...
    flist.push_back (std::make_pair (base
                                     ...
                                     32784));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0_dec_fc2_bias_optimizer_"
    ...
    flist.push_back (std::make_pair (base
                                     ...
                                     1040));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0_dec_fc2_matrix_optimizer_"
    ...
    flist.push_back (std::make_pair (base
                                     ...
                                     131088));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0_disc0_fc0_bias_optimizer_"
                                           "adam_moment1_128x1.bin",
                                     528));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0_disc0_fc0_bias_optimizer_"
                                     ...
                                     528));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0_disc0_fc0_matrix_optimizer_"
    ...
    flist.push_back (std::make_pair (base
                                     ...
                                     8406544));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0_disc0_fc1_bias_optimizer_"
                                           "adam_moment1_64x1.bin",
                                     272));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0_disc0_fc1_bias_optimizer_"
                                     ...
                                     272));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0_disc0_fc1_matrix_optimizer_"
    ...
    flist.push_back (std::make_pair (base
                                     ...
                                     32784));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0_disc0_fc2_bias_optimizer_"
    ...
    flist.push_back (std::make_pair (base
                                     ...
                                     20));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0_disc0_fc2_matrix_optimizer_"
    ...
    flist.push_back (std::make_pair (base
                                     ...
                                     272));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0_enc_fc0_bias_optimizer_"
    ...
    flist.push_back (std::make_pair (base
                                     ...
                                     144));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0_enc_fc0_matrix_optimizer_"
    ...
    flist.push_back (std::make_pair (base
                                     ...
                                     2099088));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0_enc_fc1_bias_optimizer_"
                                           "adam_moment1_256x1.bin",
                                     1040));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0_enc_fc1_bias_optimizer_"
                                     ...
                                     1040));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0_enc_fc1_matrix_optimizer_"
    ...
    flist.push_back (std::make_pair (base
                                     ...
                                     32784));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0_enc_fc2_bias_optimizer_"
                                           "adam_moment1_128x1.bin",
                                     528));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0_enc_fc2_bias_optimizer_"
                                     ...
                                     528));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0_enc_fc2_matrix_optimizer_"
    ...
    flist.push_back (std::make_pair (base
                                     ...
                                     131088));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0enc_out_bias_optimizer_adam_"
                                           "moment1_20x1.bin",
                                     96));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0enc_out_bias_optimizer_adam_"
                                     ...
                                     96));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0enc_out_matrix_optimizer_"
    ...
    flist.push_back (std::make_pair (base
                                     ...
                                     10256));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0pred_y_bias_optimizer_adam_"
                                           "moment1_16399x1.bin",
                                     65612));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0pred_y_bias_optimizer_adam_"
                                     ...
                                     65612));
    flist.push_back (std::make_pair (base
                                         + "train_macc_wae0pred_y_matrix_optimizer_"
