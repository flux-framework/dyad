...
/**
 * base64_encode_triplet_using_maps - encode 3 bytes into base64 using a specific
 * alphabet
 ...
 */
void base64_encode_tail_using_maps (const base64_maps_t *maps,
                                    char dest[4],
                                    const char *src,
                                    size_t srclen);
...
/**
 * base64_decode_quartet_using_maps - decode 4 bytes from base64 using a specific
 * alphabet
 * @param maps A base64 maps object (see base64_init_maps)
 * @param dest Buffer containing 3 bytes
...
/**
 * base64_decode_tail_using_maps - decode the final bytes of a base64 string using a
 * specific alphabet
 * @param maps A base64 maps object (see base64_init_maps)
 * @param dest Buffer containing 3 bytes
 ...
 */
ssize_t base64_decode_tail_using_maps (const base64_maps_t *maps,
                                       char dest[3],
                                       const char *src,
                                       size_t srclen);
...
{
    return base64_decode_tail_using_maps (&base64_maps_rfc4648, dest, src, srclen);
}
