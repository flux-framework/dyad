...
flux exec -r 0 flux module load ${SPACK_ENV}/lib/dyad.so  --mode="$DYAD_DTL_MODE" $DYAD_PATH/0
flux exec -r 1 flux module load ${SPACK_ENV}/lib/dyad.so  --mode="$DYAD_DTL_MODE" $DYAD_PATH/1
